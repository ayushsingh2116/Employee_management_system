...
class Employee :
    def __init__(self,root) :
        ...
        lbl_title = Label(self.root,text="EMPLOYEE MANAGEMENT SYSTEM",
                          font=('times new roman',37,'bold'),fg='navy',bg='navajo white')
        lbl_title.place(x=0,y=0,width=1365,height=50)
        
        # logo
        img_logo = Image.open('./images/icon1.png')
        ...
        img_frame.place(x=0,y=50,width=1530,height=160)
         ...
         # 1st image
        img1 = Image.open("./images/img3.png")
        img1 = img1.resize((420, 160))
        self.photo1 = ImageTk.PhotoImage(img1)

        self.img_1 = Label(img_frame, image=self.photo1)
        self.img_1.place(x=0, y=0, width=420, height=160)

        #2nd image
        img2 = Image.open('./images/employee.png')
        img2 = img2.resize((500,180))
        self.photo2 = ImageTk.PhotoImage(img2)

        self.img_2 = Label(img_frame,image=self.photo2)
        self.img_2.place(x=420,y=0,width=500,height=180)

       # 3rd image
        img3 = Image.open("./images/img3.png")
        img3 = img3.resize((400,160))
        self.photo3 = ImageTk.PhotoImage(img3)

        self.img_3 = Label(img_frame, image=self.photo3)
        self.img_3.place(x=910, y=0, width=440, height=160)

        # main frame
        Main_frame=Frame(self.root,bd=2,relief='ridge',bg='navajo white')
        Main_frame.place(x=0,y=200,width=1365,height=580)
        ...
        lbl_dep = Label(upper_frame,text="Department",font=('arial',11,'bold'),bg='white',fg='navy')
        ...
        lbl_name = Label(upper_frame,text="Name",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_name.grid(row=0,column=2,sticky=W)

        entry_name = Entry(upper_frame,textvariable=self.name,font=('arial',11),width=20)
        entry_name.grid(row=0,column=3,padx=2,sticky=W)

        #label for entry field for phone
        lbl_phone = Label(upper_frame,text="Phone",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_phone.grid(row=0,column=4,sticky=W)

        entry_phone = Entry(upper_frame,textvariable=self.phone,font=('arial',11),width=20)
        entry_phone.grid(row=0,column=5,padx=2,sticky=W)

        #label for entry field for email
        lbl_email = Label(upper_frame,text="Email",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_email.grid(row=1,column=0,padx=2,pady=7,sticky=W)

        entry_email = Entry(upper_frame,textvariable=self.email,font=('arial',11),width=20)
        entry_email.grid(row=1,column=1,padx=2,pady=7,sticky=W)

         #label for entry field for address
        lbl_address = Label(upper_frame,text="Address",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_address.grid(row=1,column=2,padx=2,pady=7,sticky=W)

        entry_address = Entry(upper_frame,textvariable=self.address,font=('arial',11),width=20)
        entry_address.grid(row=1,column=3,padx=2,pady=7,sticky=W)

         #label for entry field for country
        lbl_country = Label(upper_frame,text="Country",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_country.grid(row=1,column=4,padx=2,pady=7,sticky=W)

        entry_country = Entry(upper_frame,textvariable=self.country,font=('arial',11),width=20)
        entry_country.grid(row=1,column=5,padx=2,pady=7,sticky=W)

         #label for entry field for DOB
        lbl_DOB = Label(upper_frame,text="DOB",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_DOB.grid(row=2,column=0,padx=2,pady=7,sticky=W)

        entry_DOB = Entry(upper_frame,textvariable=self.dob,font=('arial',11),width=20)
        entry_DOB.grid(row=2,column=1,padx=2,pady=7,sticky=W)

         #label for entry field for DOJ
        lbl_DOJ = Label(upper_frame,text="DOJ",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_DOJ.grid(row=2,column=2,padx=2,pady=7,sticky=W)

        entry_DOJ= Entry(upper_frame,textvariable=self.doj,font=('arial',11),width=20)
        entry_DOJ.grid(row=2,column=3,padx=2,pady=7,sticky=W)

         #label for entry field for Salary (CTC)
        lbl_CTC = Label(upper_frame,text="CTC",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_CTC.grid(row=2,column=4,padx=2,pady=7,sticky=W)

        entry_CTC= Entry(upper_frame,textvariable=self.salary,font=('arial',11),width=20)
        entry_CTC.grid(row=2,column=5,padx=2,pady=7,sticky=W)


        
        #label for combo field for Married Status
        lbl_Married_status = Label(upper_frame,text="Married Status",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_Married_status.grid(row=3,column=0,padx=2,pady=7,sticky=W)

        lbl_combo = ttk.Combobox(upper_frame,textvariable=self.married,font=('arial',11),width=20,state='readonly')
        lbl_combo['value'] =("Married","Un Married")
        lbl_combo.current(0)
        lbl_combo.grid(row=3,column=1,padx=2,pady=7,sticky=W)

         #label for combo field for gender
        lbl_gender = Label(upper_frame,text="Gender",font=('arial',11,'bold'),bg='white',fg='navy')
        lbl_gender.grid(row=3,column=2,padx=2,pady=7,sticky=W)

        lbl_combo = ttk.Combobox(upper_frame,textvariable=self.gender,font=('arial',11),width=20,state='readonly')
        ...
        entry_id_proof =Entry(upper_frame,textvariable=self.idProof,font=('arial',11),width=20)
        entry_id_proof.grid(row=4,column=1,padx=2,pady=7,sticky=W)


        #Add Employee Image
        employeeImg= Image.open('./images/icon1.png')
        ...
        button_frame = Frame(upper_frame,bd=2,relief='ridge',bg='navajo white')
        button_frame.place(x=1100,y=4,width=125,height=190)

        btn_save = Button(button_frame,text="Save",command=self.AddData,font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
        btn_save.grid(row=0,column=0,pady=7,sticky=W)

        btn_update = Button(button_frame,command=self.updateData,text="Update",font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
        btn_update.grid(row=1,column=0,pady=7,sticky=W)

        btn_delete = Button(button_frame,text="Delete",command=self.deleteData,font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
        btn_delete.grid(row=2,column=0,pady=7,sticky=W)

        btn_reset = Button(button_frame,text="Reset",command=self.resetEmployeeInfo,font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
        btn_reset.grid(row=3,column=0,pady=7,sticky=W)

        # down frame
        down_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='navajo white',
                                 text='Employee Management Information Table',
                                 font=('arial',12,'bold'),fg='black')
        down_frame.place(x=10,y=230,width=1340,height=240)

        #searh Frame
        search_frame= LabelFrame(down_frame,text="Search Employee Information",relief='ridge',bd=2,font=('arial',11,'bold'),fg='black', bg='navajo white')
        ...
        btn_search = Button(search_frame,command=self.searchEmployeeInfo,text="Search",font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
        btn_search.grid(row=0,column=3,padx=4,pady=2,sticky=W)

        btn_showAll = Button(search_frame,text="Show All",command=self.ShowAll,font=('arial',12,'bold'),fg='white',bg='thistle4',width=12)
    ...
    def AddData(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="root",password="root1610",database="EMPmanagement")
        cursor = conn.cursor()
        try:
    ...
    def deleteData(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="root1610",database="EMPmanagement")
        cursor= conn.cursor()
